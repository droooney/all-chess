  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Overview>
          <p>
            Atomic chess is a variant where any capture causes an explosion of multiple pieces. Exploding the opponent's king wins the game.
          </p>
        </Overview>
        ...
        <Moves>
          ...
          <section>
            ...
            <p>
              When a pawn captures en passant the explosion center is not the captured pawn square, but the capturing pawn destination square
