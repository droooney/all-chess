...
declare const SocketIOClient: SocketIOClientStatic;
...
declare namespace SocketIOClient {
  ...
  interface Socket extends Emitter {
     ...
     * @return This Socket
     */
    emit<K extends keyof SocketIOClientEventWithDataMap>(event: K, data: SocketIOClientEventWithDataMap[K]): Socket;
    emit<K extends SocketIOClientEventWithoutDataList>(event: K): Socket;

    on<K extends keyof SocketIOServerEventWithDataMap>(event: K, listener: (data: SocketIOServerEventWithDataMap[K]) => any): Socket;
    on<K extends SocketIOServerEventWithoutDataList>(event: K, listener: () => any): Socket;
